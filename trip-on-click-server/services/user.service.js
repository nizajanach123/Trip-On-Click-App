...
const createUserForTest = async (req, res) => {
    try {
        const { username, email, password } = req.body;
        const user = await User.create({ username, email, password });
        user.trips[0] = '63b38a96cb87269fd8a0a073';
...
module.exports = {changePassword,sendLink,userAuth, getAllUsers, register, getUserById, deleteUser, updateUser, login, createUserForTest, getUserConnected };